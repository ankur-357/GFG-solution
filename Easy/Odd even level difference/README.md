<h2><a href="https://practice.geeksforgeeks.org/problems/odd-even-level-difference/1?page=2&category[]=Tree&sortBy=difficulty">Odd even level difference</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a Binary Tree. Find the difference between the sum of node values at even levels and the sum of node values at the odd levels.</span></p>
