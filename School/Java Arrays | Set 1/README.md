<h2><a href="https://practice.geeksforgeeks.org/problems/java-arrays-set-11354/1?page=1&category[]=Arrays&sortBy=difficulty">Java Arrays | Set 1</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">For a given array of price of items,you have to calculate the average of all prices upto 2 decimal places.<br>
