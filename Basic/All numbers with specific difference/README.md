<h2><a href="https://practice.geeksforgeeks.org/problems/all-numbers-with-specific-difference3558/1?page=1&category[]=Binary%20Search&sortBy=difficulty">All numbers with specific difference</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a positive number <strong>N</strong> and a number <strong>D</strong>.&nbsp; Find the count of positive numbers smaller or equal to&nbsp; N such that the difference between the number and sum of its digits is greater than or equal to given specific value D.</span></p>
